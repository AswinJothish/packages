    ...
    return (
        ...
        <div className="flex flex-col rounded">
            <div className="flex w-full justify-between items-center">
                <h1 className="md:px-5 px-2 pt-5 font-bold md:text-2xl text-lg font-serif">Our Products</h1>
                ...
                {products.length > 0 ? (
                    <>
                        {products.slice(0, 12).map((product) => (
                            <div
                                key={product._id}
                                className="md:h-72 bg-white shadow md:shadow-none h-52 md:min-w-60 min-w-32 rounded-xl transform transition-all duration-300 group hover:shadow-lg md:hover:border hover:border-neutral-100 border border-gray-100 md:border-none"
                            >
                                <div
                                    ...
                                    >
                                        ...
                                        <p className="mt-2 md:text-base  text-sm font-merr font-medium">
                                            {role === "dealer" ? (
                                                ...
                                                <>
                                                    <span className="md:text-base text-xs pr-0.5 mt-0.5 font-sans font-medium">
                                                        &#8377;
                                                    </span>
