    ...
    <div className="w-full ">
      <div className="px-5 bg-white rounded-xl shadow-sm">
        <div className="flex justify-between  items-center py-4">
          <h2  onClick={() => setIsExpanded(!isExpanded)} className="text-lg font-bold font-serif">Delivery Address</h2>
        ...
        {isExpanded && (
  <div className="grid max-h-[70vh] overflow-y-auto grid-cols-1 md:grid-cols-2 gap-4 pb-4">
    {addresses.length > 0 ? (
