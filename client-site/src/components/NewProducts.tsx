    ...
    return (
        ...
        <div className="flex flex-col rounded">
            <div className="flex w-full justify-between items-center">
                <h1 className="md:px-5 px-2 py-3 font-bold md:text-2xl text-lg font-serif">New Products</h1>
    
                {/* Arrows for larger screens */}
                <p className="px-5 cursor-pointer  justify-between items-center gap-2 md:flex hidden">
                    <span
            ...
            <div
                ref={scrollRef}
                className="md:p-5 md:pt-10 px-2  flex overflow-x-auto overflow-y-hidden md:gap-10 gap-3 scrollbar-hide"
            >
                {products.length > 0 ? (
                    <>
