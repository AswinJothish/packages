...
if(isLoading){
  ...
  return (
    <div className=" ">
    <div className="flex py-5  bg-blue-900/90 text-white text-center  mb-6">
      <div className="flex pl-5 w-auto items-center mr-4 cursor-pointer" onClick={() => window.history.back()}>
        <FaArrowLeft />
      </div>

      <h1 className="text-3xl -pl-5 font-bold flex-grow text-center">Terms and Conditions</h1>
    </div>
     <div className="flex justify-center items-center">
     <div
        className="prose lg:w-3/4 px-5  terms-condition-content  lg:prose-xl"
